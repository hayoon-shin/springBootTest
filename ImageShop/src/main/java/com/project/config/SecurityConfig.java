...
// 스프링 시큐리티의 UserDetailsService를 구현한 클래스를 빈으로 등록한다.
	...
	public UserDetailsService createUserDetailsService() {
		return new com.project.common.security.CustomUserDetailsService();
	}

// 사용자가 정의한 비번 암호화 처리기를 빈으로 등록한다.
//	@Bean
//	public PasswordEncoder createPasswordEncoder() {
//		return new com.project.common.security.CustomNoOpPasswordEncoder();
//	}
...
// CustomLoginSuccessHandler를 빈으로 등록한다.
	...
	public AuthenticationSuccessHandler createAuthenticationSuccessHandler() {
		return new com.project.common.security.CustomLoginSuccessHandler();
	}

// CustomAccessDeniedHandler를 빈으로 등록한다.
	@Bean
	public AccessDeniedHandler createAccessDeniedHandler() {
		return new com.project.common.security.CustomAccessDeniedHandler();
	}
}