...
public class BoardController {
	...
	// 게시글 상세내용글 요쳥 -> 한개의 게시판 정보를 가져와서 -> /WEB-INF/views/board/read.jsp 화면에 전달한다.
	// (모델에 저장하는데 이 모델은 리퀘스트에 있다)
	...
	// 게시글 수정하기 위한 화명 요청(GET방식) -> 해당된 게시글을 가져와서 -> /WEB-INF/views/board/modify.jsp
	// 화면에 전달한다.
	...
	// 게시글 수정 내용을 디비 저장 요청 -> 수정된 게시글 수정완료 -> 결과화면 성공메세지를
